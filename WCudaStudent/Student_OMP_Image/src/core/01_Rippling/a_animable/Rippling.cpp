 ...
 */
void Rippling::processForAutoOMP(uchar4* tabPixels , uint w , uint h , const DomaineMath& domaineMath)
    {
    // TODO Rippling CPU
 ...
 * Image non zoomable : domaineMath pas use ici
 */
void Rippling::processEntrelacementOMP(uchar4* tabPixels , uint w , uint h , const DomaineMath& domaineMath)
    {
    // TODO Rippling CPU
   // assert(false); // to delete once implement
    }
