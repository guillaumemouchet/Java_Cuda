 ...
 */
void Mandelbrot::processForAutoOMP(uchar4* tabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    int n = t;
 ...
 * domaineMath use car image zoomable
 */
void Mandelbrot::processEntrelacementOMP(uchar4* tabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    int n = t;
