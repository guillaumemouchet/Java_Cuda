...
__host__ void uploadToCM(Sphere* tabSpheres , int nbSpheres)
    ...
    size_t sizeSpheres = nbSpheres*sizeof(Sphere); // TODO taille en octets de toute les spheres

    const bool IS_V1 = false; // TODO essayer avec true et false. Difference de performance?
    if (IS_V1)
	{
