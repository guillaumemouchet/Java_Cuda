...
int mainImageSimple(const Args& args)
    {
    cout << "\n[Image] mode" << endl;
    ...
    // Lors du rendu deplacer les windows elles sont toutes aux meme endroit:

    Viewer<VagueProvider> vague(nozoomable);
...
/**
 * Position des windows, bugger!
 */
int mainImageAdvanced(const Args& args)
    {
    cout << "\n[Image] mode" << endl;
